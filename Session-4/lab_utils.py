...
===================================================================================
This module encapsulates boilerplate Matplotlib visualization routines and
evaluation helpers so mathematics and STEM faculty can focus exclusively on
understanding PyTorch Dataset modeling, transforms.v2 pipelines, DataLoader
mini-batching, and forward model execution.
"""
